			...
			<div class="left clearfix">
				<div class="leftauto">
					...
					<div>
						...
						<dl class="clearfix ">
							<dt><em class="must" style="color: #F60;">*</em><?=_('图形验证码：')?></dt>
							<dd>
					...
					<div>
						<dl class="clearfix ">
							<dt><em style="color: #F60;">*</em>验证码：</dt>
							<dd>
...
//				}
			...
			valid:function(form){
				...
				$.ajax({
					url: ajax_url,
					data:{id:id,bank_name:bank_name,cardno:cardno,bank:bank,
                        withdraw_money:withdraw_money,con:con,paypasswd:paypasswd,
                        yzm:yzm,mobile:mobile,val:val,fee:fee},
					success:function(a){
						console.info(a);
						if(a.status == 200)
						{
