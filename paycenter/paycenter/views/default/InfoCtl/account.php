		...
		<div class="account_mes">
			...
			<table class="account_table">
				...
				<tr>
                  ...
                  <td>
                    <div class="user-avatar"><span><img  id="image_img"  src="<?=$user_info['user_identity_face_logo'] ?>" width="" height="120" nc_type="avatar"></span></div>
                  </td>
				  <td class="account_ahref"></td>
                </tr>
				<tr>
                  ...
                  <td>
                    <div class="user-avatar"><span><img  id="image_img"  src="<?=$user_info['user_identity_font_logo'] ?>" width="" height="120" nc_type="avatar"></span></div>
                  </td>
				  <td class="account_ahref"></td>
                </tr>
				</tbody>
