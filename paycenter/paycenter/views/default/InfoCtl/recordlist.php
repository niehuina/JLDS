		...
		<div class="recharge-content-center content-public clearfix">
			...
			<div class="Second clearfix">
				...
				<div class="trade_class">
					...
					<span class="<?php if($status== 'doing'){?>btn btn_active<?php }?>"><a href="<?=Yf_Registry::get('url')?>?ctl=Info&met=recordlist<?php if($time){?>&time=<?=$time?><?php }?>&status=doing<?php if($type){?>&type=<?=$type?><?php }?><?php if($record_delete){?>&record_delete=<?=$record_delete?><?php }?>"><?=_('处理中')?></a></span>
