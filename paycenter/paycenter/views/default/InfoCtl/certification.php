            ...
            <div class="account_left fl">
                <div class="account_mes">
                    ...
                    <table class="account_table">
	                    ...
	                    <span>
	                 		   <img  id="image_img"  src="<?=$data['user_identity_face_logo']?$data['user_identity_face_logo']:'holder.js/120x120'; ?>" width="" height="120" nc_type="avatar">
	                    </span>
                                </div>
                     ...
                     <input name="user_identity_face_logo" id="user_identity_face_logo" type="hidden" value="<?=$data['user_identity_face_logo']?>" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="user-avatar"><span><img  id="image_font_img"  src="<?=$data['user_identity_font_logo']?$data['user_identity_font_logo']:'holder.js/120x120' ?>" width="" height="120" nc_type="avatar"></span></div>
