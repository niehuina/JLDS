                ...
                <div class="account_mes">
                    ...
                    <table class="account_table">
                        ...
                        <tr>
                            ...
                            <input type="hidden" value="<?= $data['user_name'] ?>" name="user_name" id="user_name">
                        </tr>
                        <tr>
                            <td class="check_name"><?= _('真实姓名：') ?></td>
                            <td><input type="text" class="w168" value="<?= $data['user_realname'] ?>"
                                       name="user_realname" id="real_name">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="user_identity_type" id="user_identity_type">
                                    <option value="1"
                                            <?php if ($data['user_identity_type'] == 1){ ?>selected<?php } ?>><?= _('身份证') ?></option>
                                    <option value="2"
                                            <?php if ($data['user_identity_type'] == 2){ ?>selected<?php } ?>><?= _('护照') ?></option>
                                    <option value="3"
                                            <?php if ($data['user_identity_type'] == 3){ ?>selected<?php } ?>><?= _('军官证') ?></option>
                                </select>
                                <div class="form-error"></div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" maxlength="18" class="w168"
                                       value="<?= $data['user_identity_card'] ?>" name="user_identity_card"
                                       id="identity_card"
                                       onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d[a-zA-Z].]/g,''))"
                        ...
                        <tr>
                            <td><?= _('证件有效期：') ?></td>
                            <td><input readonly="readonly" id="start_time" name="user_identity_start_time"
                                       class="w90 hasDatepicker" type="text"
                                       value="<?php echo $data['user_identity_start_time'] > 0 ? $data['user_identity_start_time'] : ''; ?>"/><em><i
                                            class="iconfont icon-rili"></i></em>
                                <span></span>-
                                <input readonly="readonly" id="end_time" name="user_identity_end_time"
                                       class="w90 hasDatepicker" type="text"
                                       value="<?php echo $data['user_identity_end_time'] > 0 ? $data['user_identity_end_time'] : ''; ?>"/><em><i
                                            class="iconfont icon-rili"></i></em>
                            </td>
                        </tr>
                        <tr>
	                    ...
	                    <span>
	                 		   <img id="image_img"
                                    src="<?= $data['user_identity_face_logo'] ? $data['user_identity_face_logo'] : 'holder.js/120x120'; ?>"
                                    width="" height="120" nc_type="avatar">
	                    </span>
                                </div>
                                <p class="hint mt5"><span style="color:orange;"><?= _('正面照尺寸为') ?><span class="phosize">240x151</span><?= _('像素，请根据系统操作提示进行裁剪并生效。') ?></span>
                                </p>
                            </td>
                        </tr>
                        <tr>
                     ...
                     <input name="user_identity_face_logo" id="user_identity_face_logo" type="hidden"
                            value="<?= $data['user_identity_face_logo'] ?>"/>
                      </span>
                                        <p id='user_upload' style="float:left;" class="bbc_btns"><i
                                                    class="iconfont icon-upload-alt"></i><?= _('图片上传') ?></p>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="user-avatar"><span><img id="image_font_img"
                                                                    src="<?= $data['user_identity_font_logo'] ? $data['user_identity_font_logo'] : 'holder.js/120x120' ?>"
                                                                    width="" height="120" nc_type="avatar"></span></div>
                                <p class="hint mt5"><span style="color:orange;"><?= _('背面照尺寸为') ?><span class="phosize">240x151</span><?= _('像素，请根据系统操作提示进行裁剪并生效。') ?></span>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div><a href="javascript:void(0);"><span>
                     <input name="user_identity_font_logo" id="user_identity_font_logo" type="hidden"
                            value="<?= $data['user_identity_font_logo'] ?>"/>
                      </span>
                                        <p id='user_font_upload' style="float:left;" class="bbc_btns"><i
                                                    class="iconfont icon-upload-alt"></i><?= _('图片上传') ?></p>
