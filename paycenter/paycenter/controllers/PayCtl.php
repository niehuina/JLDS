...
//		//如果是合并支付订单
//		if(strpos($uorder['inorder'], ',') !== false)
//		{
//			$order_id_arr = explode($uorder['inorder'], ',');
//			$consume_trade_info = $Consume_TradeModel->getByWhere(['consume_trade_id:IN'=>$order_id_arr]);
//		}
//		else
//		{
//			$consume_trade_info = $Consume_TradeModel->getByWhere(['consume_trade_id'=>$uorder['inorder']]);
//		}

//		foreach($consume_trade_info as $key=>$val)
//		{
//			$user_id_row = $val['seller_id'];
//			echo '<pre>';print_r($val['order_id']);exit;
//			try{
//				//订单付款成功后进行极光推送
...
//			}
//		}
//		echo '<pre>';print_r($consume_trade_info);exit;
		/****************************************************************************************************/
