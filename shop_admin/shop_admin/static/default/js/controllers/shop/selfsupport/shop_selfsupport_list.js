...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'shop_organization', label:'组织机构编码',  width:100, align:"center"},
            {name:'shop_organization_name', label:'组织机构名称',  width:200, align:"center"},
            {name:'shop_saler_id', label:'erp_saler_id',  width:200, align:"center"}
        ];
...
function operFmattershop(val, opt, row) {
    if(row.shop_all_class){
        var html_con = '<div class="operating" data-id="' + row.shop_id + '"><span class="ui-icon ui-icon-gear" title="修改"></span><span class="ui-icon ui-icon-trash" title="删除"></span></div>';
    }else{
