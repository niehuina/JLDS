var handle = {
    ...
    imageFmatterApp: function (val, opt, row)
    {
        if (row.cat_app_home_pic)
        {
            val = '<img src="' + row.cat_app_home_pic + '" style="width:100px;height:40px;">';
        }
        else
        {
            val = '&#160;';
...
// }, {
    ...
    "name": "cat_app_home_pic",
    "index": "cat_app_home_pic",
    "label": "APP首页显示图片",
    "classes": "ui-ellipsis",
    "align": "center",
    "title": false,
    "width": 100,
    "formatter": handle.imageFmatterApp,
    "sortable": false
},{
    "name": "cat_app_home_name",
    "index": "cat_app_home_name",
    "label": "APP首页显示名称",
    "classes": "ui-ellipsis",
    "align": "center",
    "title": false,
    ...
    "name": "cat_app_home_is_show",
    "index": "cat_app_home_is_show",
    "label": "是否APP首页显示",
    "classes": "ui-ellipsis",
    "align": "center",
    "title": false,
    ...
    "name": "cat_app_home_displayorder",
    "index": "cat_app_home_displayorder",
    "label": "APP首页显示顺序",
    "classes": "ui-ellipsis",
    "align": "center",
    "title": false,
    ...
    "name": "cat_app_home_click_url",
    "index": "cat_app_home_click_url",
    "label": "APP首页跳转链接",
    "classes": "ui-ellipsis",
    "align": "center",
    "title": false,
