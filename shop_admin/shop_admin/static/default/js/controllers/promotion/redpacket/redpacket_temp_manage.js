...
function postData(t, e)
{
    $_form.validator({
        ...
        valid: function (form)
        {
            ...
            if($("input[name='redpacket_t_is_support_all']").is(':checked'))
            {
                var redpacket_t_is_support_all = 1;
            }
            else
            {
                var redpacket_t_is_support_all = 0;
            }

            params = {
                redpacket_t_title  : redpacket_t_title,
                redpacket_t_type   : redpacket_t_type,
                redpacket_t_is_support_all : redpacket_t_is_support_all,
