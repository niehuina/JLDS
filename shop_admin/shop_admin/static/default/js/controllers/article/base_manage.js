...
function initField(){
    if(rowData.id){
        ...
        if(rowData.article_app_flag=="1") {
            $("#article_app_flag1").attr('checked', true);
            $("#article_app_flag2").attr('checked', false);
            $('[for="article_app_flag1"]').addClass('selected');
            $('[for="article_app_flag2"]').removeClass('selected');
        }
        else
        {
            $("#article_app_flag1").attr('checked', false);
            $("#article_app_flag2").attr('checked', true);
            $('[for="article_app_flag1"]').removeClass('selected');
            $('[for="article_app_flag2"]').addClass('selected');
        }
