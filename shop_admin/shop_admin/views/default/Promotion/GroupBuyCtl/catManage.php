		...
		<ul class="mod-form-rows">
			...
			<li class="row-item">
				...
				<div class="ctn-wrap">
				    ...
				    <input type="radio" name="cat_type" class="cat_type" value="2">服务
				    <div class="ctn-wrap"><input type="hidden" value="1" class="ui-input" name="groupbuy_cat_type" id="groupbuy_cat_type"></div>
				</div>
			</li>
			<li class="row-item">
