...
<body>
	<form id="manage-form" action="#">
        ...
        <dl class="row row-item">
            <dt class="tit">
                <label for="redpacket_t_is_support_all">全平台可用</label>
            </dt>
            <dd class="opt">
                <input type="checkbox" class="checkbox" name="redpacket_t_is_support_all"
                       id="redpacket_t_is_support_all" value="">允许
                <span class="err"></span>
                <p class="notic">勾选允许时，该红包全平台可用，否则只有平台自营可用</p>
            </dd>
        </dl>
        <dl class="row row-item">
            <dt class="tit">
