        ...
        <form method="post" enctype="multipart/form-data" id="index_slider-setting-form" name="form1">
            ...
            <div class="ncap-form-default">
                <dl class="row">
                    ...
                    <dd class="opt">
                        <img id="index_slider1_review" src="<?php if(isset(Perm::$row['sub_site_id']) && Perm::$row['sub_site_id']){echo @$data[Perm::$row['sub_site_id'].'index_slider_image1']['config_value'];}else{ echo @$data['index_slider_image1']['config_value'];}?>" width="950" height="200"/>
                        ...
                        <p class="notic">请使用宽度1900像素，高度400像素的jpg/gif/png格式图片作为幻灯片banner上传，<br>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <img id="index_slider2_review" src="<?php if(isset(Perm::$row['sub_site_id']) && Perm::$row['sub_site_id']){echo @$data[Perm::$row['sub_site_id'].'index_slider_image2']['config_value'];}else{ echo @$data['index_slider_image2']['config_value'];}?>" width="950" height="200"/>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <img id="index_slider3_review" src="<?php if(isset(Perm::$row['sub_site_id']) && Perm::$row['sub_site_id']){echo @$data[Perm::$row['sub_site_id'].'index_slider_image3']['config_value'];}else{ echo @$data['index_slider_image3']['config_value'];}?>" width="950" height="200"/>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <img id="index_slider4_review" src="<?php if(isset(Perm::$row['sub_site_id']) && Perm::$row['sub_site_id']){echo @$data[Perm::$row['sub_site_id'].'index_slider_image4']['config_value'];}else{ echo @$data['index_slider_image4']['config_value'];}?>" width="950" height="200"/>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <img id="index_slider5_review" src="<?php if(isset(Perm::$row['sub_site_id']) && Perm::$row['sub_site_id']){echo @$data[Perm::$row['sub_site_id'].'index_slider_image5']['config_value'];}else{ echo @$data['index_slider_image5']['config_value'];}?>" width="950" height="200"/>
                ...
                if ( agent.indexOf("msie") > -1 && (version = agent.match(/msie [\d]/), ( version == "msie 8" || version == "msie 9" )) ) {
                    ...
                    $('#index_slider1_upload, #index_slider2_upload, #index_slider3_upload,#index_slider4_upload,#index_slider5_upload').on('click', function () {
                        ...
                        if ( this.id == 'index_slider1_upload' ) {
                            ...
                            imageWidth = 1900, imageHeight = 400;
