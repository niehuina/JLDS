    ...
    <form method="post" enctype="multipart/form-data" id="points-setting-form" name="form">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="points_period" name="points[points_period]" value="<?=($data['points_period']['config_value'])?>" class="ui-input w400" type="text"/>
                    <p class="notic">单位为月。例:设置为3，表明3个月前的积分都过期</p>
                </dd>
            </dl>
