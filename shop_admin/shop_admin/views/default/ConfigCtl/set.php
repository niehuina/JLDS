...
?>
    ...
    <div class="wrapper page">
        ...
        <form id="set-setting-form" method="post" enctype="multipart/form-data" name="settingForm">
...
<!--                </dl>-->
                <dl class="row">
                    ...
                    <dd class="opt">
                        <input id="webservice_qq" name="set[webservice_qq]" value="<?=(@$data['webservice_qq']['config_value'])?>" class="ui-input w400" type="text"/>
                        <p class="notic"></p>
                    </dd>
                </dl>
<!--                <dl class="row">-->
