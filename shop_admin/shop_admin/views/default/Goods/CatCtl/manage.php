...
<!--        </dl>-->
        ...
        <dl class="row">
            <dt class="tit">
                <!-- cat_app_home_pic -->
                <label for="cat_app_home_image">APP首页显示图片</label>
            </dt>
            <dd class="opt">
                <img id="cat_app_home_image" name="setting[cat_app_home_logo]" alt="选择图片" src="./shop_admin/static/common/images/image.png"  class="image-line" />
                <div class="image-line"  id="cat_app_home_upload">上传图片<i class="iconfont icon-tupianshangchuan"></i></div>
                <p class="notic">上传分类图片时，请上传宽度不低于240像素，高度不低于200像素的图片</p>
                <input id="cat_app_home_logo" name="setting[cat_app_home_logo]" value="" class="ui-input w400" type="hidden"/>
            </dd>
        </dl>
        <dl class="row">
            <dt class="tit">
                <label for="cat_app_home_name">APP首页显示名称</label>
            </dt>
            <dd class="opt">
                <!--<input type="text" maxlength="20" value="" name="cat_app_home_name" id="cat_app_home_name" class="ui-input ui-input-ph">-->
                <textarea value="" name="cat_app_home_name" id="cat_app_home_name" class="ui-input ui-input-ph" /></textarea>
                <span class="err"></span>
                <p class="notic">批量添加商品分类的时候，以回车键隔开</p>
            </dd>
        </dl>
        <dl class="row">
            ...
            <dd class="opt">
                <div style="float: left;width:50%;">
                    <label>
                        <input type="checkbox" class="checkbox" name="cat_app_home_is_show" id="cat_app_home_is_show" value="">允许
                    </label>
                    <p class="notic mb10">勾选允许APP首页显示后，该分类会显示在APP首页。</p>
                </div>
            </dd>
        </dl>
        <dl class="row">
            <dt class="tit">
                <label for="cat_app_home_displayorder">APP首页显示排序</label>
            </dt>
            <dd class="opt">
                <input type="text" value="0" name="cat_app_home_displayorder" id="cat_app_home_displayorder" class="ui-input ui-input-ph">
                <span class="err"></span>
                <p class="notic">数字范围为0~255，数字越小越靠前</p>
            </dd>
        </dl>
        <dl class="row">
            <dt class="tit">
                <label for="cat_app_home_click_url">APP首页跳转链接</label>
            </dt>
            <dd class="opt">
...
<script>
    //图片上传
    $(function(){
        var cat_upload = new UploadImage({
            thumbnailWidth: 240,
            thumbnailHeight: 200,
        ...
        var cat_app_home_upload = new UploadImage({
            thumbnailWidth: 240,
            thumbnailHeight: 200,
            imageContainer: '#cat_app_home_image',
            uploadButton: '#cat_app_home_upload',
            inputHidden: '#cat_app_home_logo'
        });
    })
</script>
