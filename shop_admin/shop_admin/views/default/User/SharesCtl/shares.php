...
?>
        ...
        <div class="mod-toolbar-top cf">
            <div class="left">
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                        <li>
                            <input type="text" id="searchYear" class="ui-input ui-input-ph con" value="请输入分红年份...">
                        </li>
    ...
    <script type="text/javascript" src="<?=$this->view->js?>/controllers/user/shares/list.js" charset="utf-8"></script>
<?php
