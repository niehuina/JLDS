        ...
        valid: function (form)
        {
            var 
              ...
              saler_id = $("#saler_id").val(),
                n = "Add" == t ? "新增店铺" : "修改店铺";
			params =  { shop_id: shop_id, shop_name: shop_name, shop_all_class: shop_all_class, shop_status:shop_status, new_district_id:new_district_id, district_id:district_id ,  shop_organization:  shop_organization, saler_id: saler_id};
