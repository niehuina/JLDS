...
<form id="article_form" method="post">
    <div class="ncap-form-default">
	  ...
	  <dl class="row">
        ...
        <dl class="row">
            <dt class="tit">
                <label for="if_show">是否为APP文章:</label>
            </dt>
            <dd class="opt">
                <div class="onoff">
                    <label for="article_app_flag1" class="cb-enable  ">启用</label>
                    <label for="article_app_flag2" class="cb-disable  selected">关闭</label>
                    <input id="article_app_flag1"  name ="article_app_flag"  value="1" type="radio">
                    <input id="article_app_flag2"  name ="article_app_flag"  checked="checked"  value="0" type="radio">
                </div>
                <p class="notic"></p>
            </dd>
        </dl>
