...
-- 临时关闭分站
-- delete from `yf_admin_menu` where `menu_id`='119';
-- delete from `yf_admin_menu` where `menu_id`='11017';
-- delete from `yf_admin_menu` where `menu_id`='10600';
-- delete from `yf_admin_menu` where `menu_id`='11069';
-- delete from `yf_admin_menu` where `menu_id`='11070';
...
delete from `yf_admin_menu` where `menu_id`='16006';delete from `yf_admin_menu` where `menu_id`='13005';
delete from `yf_admin_menu` where `menu_id`='13006';
