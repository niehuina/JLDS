...
<div class="head-fixed">
    <div class="header-l">
        <a href="javascript:void(0);"><i class="home"></i> </a>
    </div>
    <div class="head-ser">
<!--        <div class="cohesive " id="cohesive_dev">-->
<!--            <a href="./tmpl/changecity.html">-->
<!--                <span class="city-text sub_site_name_span">--><?php //echo __('全部'); ?>
<!--                    <i class="icon-city"></i> -->
<!--                </span>-->
...
<!--            <a class="qrcode_open scan" href="/qrcode_open"><i class="icon-scan"></i><span>扫一扫</span></a>-->
            <script>
                if ($(window).width() < 360) {
                    $(".header-inps").css("width", "11.5rem");
                } else {
                    $(".header-inps").css("width", "13rem");
                }
            </script>
        <?php } ?>
        <a id="header-nav" class="message" onclick="go_message()"><i></i><span><?php echo __('消息'); ?></span></a>
    </div>
</div>
<div class="bgf borb1 mrb45 ser-mrt">
    ...
    <div class="swiper-pagination swiper-paginations" id="pagination" style="margin-top: -30px;"></div>

    <ul class="nav-class tc mrt70 four">
        ...
        <!--	    				<p>店铺精选</p>-->
        <!--	    			</a></li>-->
        <!--	    	 <li><a class="logbtn" href="javascript:void(0);"><i></i>-->
        <!--    				<p>每日签到</p>-->
        <!--    			</a></li>-->
        ...
        <div class="module1">
            ...
            <div class="layout1">
                ...
                <div class="small mrl804">
                    <a href="<%= rectangle1_url %>" class="mrb22"><img src="<%= rectangle1_image %>" alt=""></a>
    ...
    <div class="bgf bort1 borb1 mrb45 padb63">
        ...
        <div class="layout1">
            <div class="small mrr352">
                <a href="<%= rectangle1_url %>" class="mrb22"><img src="<%= rectangle1_image %>" alt=""></a><a
                        href="<%= rectangle2_url %>"><img src="<%= rectangle2_image %>" alt=""></a>
            </div>
...
<script type="text/html" id="home5">
    <div class="bgf bort1 borb1 mrb45">
        <div class="home5 ">
            <a href="<%= url %>" class="tc">
                <img src="<%= image %>" alt="">
                <% if (title) { %>
...
<script type="text/html" id="goods">
    <div class="bgf bort1 borb1 mrb45 goods_list">
        <% if (title) { %>
...
<script type="text/html" id="top_goods">
    <div class="bgf bort1 borb1 mrb45">
        <div>
            <div class="common-tit tc borb1">
                <h4> —&nbsp;&nbsp;<strong>商品销售TOP5</strong>&nbsp;&nbsp;—</h4>
            </div>
                ...
                <ul class="top-goods">
                    ...
                    <li>
                        <a href="tmpl/product_detail.html?goods_id=<%= item[i].goods_id %>">
                            <div class="overhide">
                                <div class="img-area">
                                    <img src="<%= item[i].goods_image %>" alt="" style="width: 6rem;height: 6rem;">
                                </div>
                            </div>
                            <h5><%= item[i].goods_name %></h5>
                            <b>￥<%= item[i].goods_promotion_price %></b>
...
<script type="text/html" id="cat_view">
    <div class="bgf borb1 mrb45 cat_list">
        <ul class="cat-goods clearfix wrap mt5">
        <% for (var i in item) { %>
            <li>
                <% if (item[i].cat_name) { %>
                <div class="common-tit tc">
                    <h4> —&nbsp;&nbsp;<strong><%= item[i].cat_name %></strong>&nbsp;&nbsp;—</h4>
                </div>
                <% } %>
                <a href="<%= item[i].link %>">
