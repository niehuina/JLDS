...
$(function () {
        ...
        $.ajax({
            ...
            success: function (e) {
                ...
                for (var i in e.data.items) {
                    var orderId = e.data.items[i].order_id;
                }
            }
        })
    }
    ...
    function l() {
        var e = $(this).attr("order_id");
        location.href = WapSiteUrl + "/tmpl/order/member_evaluation.html?order_id=" + e
    }

    function d() {
        var e = $(this).attr("order_id");
        location.href = WapSiteUrl + "/tmpl/order/member_evaluation_again.html?order_id=" + e
    }
