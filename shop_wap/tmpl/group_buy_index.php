...
<body>
    ...
    <script type="text/html" id="maskG">
        ...
        <div class="title">
            <a href="group_buy_list.html?groupbuy_type=2">服务团</a>
        </div>
        <ul class="list clearfix">
            <% if(cat.virtual){ %>
    ...
    <script type="text/html" id="Group-main">
        ...
        <h3 class="tit-style2">
            <a href="group_buy_list.html?groupbuy_type=2">服务团</a><i>每天整点开抢</i>
    ...
    <script type="text/javascript" src="../js/tmpl/group_buy.js"></script>
