...
<body>
    <header id="header" class="fixed" style="z-index: 1000;">
...
<!--            <div class="header-r"> <a id="header-nav" href="javascript:void(0);"><i class="more"></i><sup></sup></a> </div>-->
    ...
    <div class="nctouch-main-layout">
        <div class="nctouch-order-search fixed">
        ...
        <div id="fixed_nav" class="nctouch-single-nav fixed mt20">
        ...
        <div class="nctouch-order-list mt40">
            <ul id="order-list">
            </ul>
        </div>
        <!--底部总金额固定层End-->
                    ...
                    <li class="<%if(orderinfo.order_payment_amount){%>green-order-skin<%}else{%>gray-order-skin<%}%> <%if(i>0){%>mt10<%}%>">
                        <div class="nctouch-order-item">
                            ...
                            <%  count = 0;
                                ...
                                count += parseInt(order_goods.order_goods_num);
                            %>
                                    <div class="goods-block">
                                        <a href="<%=WapSiteUrl%>/tmpl/order/order_detail.html?order_id=<%=orderinfo.order_id%>">
                                            <div class="goods-pic">
                                            ...
                                            <dl class="goods-info">
                                                ...
                                                <dd class="goods-type">
                                                    ...
                                                    <%=order_goods.order_goods_benefit%>
                                                    <% }else{ %>
                                            ...
                                            <div class="goods-subtotal">
                                                ...
                                                <div>
                                                   <% if(order_goods.goods_return_status > 0) {%>
                                                    ...
                                                    <a href="<%=WapSiteUrl%>/tmpl/order/member_return_info.html?refund_id=<%=order_goods.order_refund_id%>" class='ml4'><span class="goods-price"><%=order_goods.goods_refund_status_con%></span></a>
                                                    <% } %>
                                                </div>
...
<!--                                </div>-->
    ...
    <script type="text/javascript" src="../../js/tmpl/order/order_list.js"></script>
