...
<body>
    <header id="header">
        <div class="header-wrap">
            ...
            <span class="header-tab"><a href="javascript:void(0);" class="cur">退款列表</a><a href="../order/member_return.html">退货列表</a></span>
                ...
                <li class=" <%if(i>0){%>mt10<%}%>">
                    <div class="nctouch-order-item">
                        <div class="nctouch-order-item-head">
                            <a href="<%=WapSiteUrl%>/tmpl/order/member_refund_info.html?refund_id=<%=refund_list[i].order_return_id%>" class="store"><i class="icon"></i><%=refund_list[i].seller_user_account%></a><span class="state"><%=refund_list[i].return_state_text%></span>
                        </div>
