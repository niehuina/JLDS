...
<header id="header" class="fixed">
    <div class="header-wrap">
        ...
        <span class="header-tab"><a href="order_list.html">实物订单</a><a href="javascript:void(0);" class="cur">服务订单</a></span>
                ...
                <div class="nctouch-order-item">
                    ...
                    <div class="nctouch-order-item-con">
                        <div class="goods-block">
                            <a href="<%=WapSiteUrl%>/tmpl/order/vr_order_detail.html?order_id=<%=order.order_id%>">
                                <div class="goods-pic">
