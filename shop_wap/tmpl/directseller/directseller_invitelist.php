...
<body>
    <header id="header" class="fixed">
        <div class="header-wrap">
            ...
            <span class="header-tab"><a href="javascript:void(0);" class="cur">推广用户</a></span>
    ...
    <script type="text/javascript" src="../../js/tmpl/directseller/directseller_invitelist.js"></script>
</body>
