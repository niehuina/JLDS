...
<body>
        ...
        <%if(items){%>
            <ul>
                ...
                <a href="/tmpl/store.html?shop_id=<%=items[i].voucher_shop_id%>">
                    ...
                    <% } %>    
                        <div class="fl">
                            <img src="<%=items[i].voucher_shop_logo%>" class="icon-logo">
                            <!-- <span class="icon-logo" style="background:url(<%=items[i].voucher_shop_logo%>) no-repeat center;"><i></i></span> -->
                            <div>
                                <h3 class="dpm"><%=items[i].voucher_shop_name%></h3>
    ...
    <script type="text/javascript" src="../../js/tmpl/member/member_voucher.js"></script>
