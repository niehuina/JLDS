...
$(function () {
    ...
    $('#form').validator({
        ...
        rules: {
            ...
            letter_price: function(element){
                if(element.name == 'price_vip'){
                ...
                }else if(element.name == 'price_partner'){
                    if($('input[name="price_vip"]').val() != ''){
                        if (Number(element.value) > Number($('input[name="price_vip"]').val())) {
                            return '不能高于商品会员价格';
                        } else {
                            return true;
                        }
        ...
        fields: {
            ...
            'price_vip':        'required;range[0.01~9999999];letter_price;',
            'price_partner':    'required;range[0.01~9999999];letter_price;',
