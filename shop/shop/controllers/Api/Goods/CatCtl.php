...
class Api_Goods_CatCtl extends Api_Controller
{
	...
	public function addCat()
	{
		...
		$data['cat_is_virtual']   = request_int('cat_is_virtual'); // 是否允许服务
	...
	public function editGoodsCat()
	{
        ...
        $cat_app_home_pic           = request_string('cat_app_home_pic');
        $cat_app_home_name          = request_string('cat_app_home_name');
        $cat_app_home_is_show       = request_int('cat_app_home_is_show');
        $cat_app_home_displayorder  = request_int('cat_app_home_displayorder');
        $cat_app_home_click_url     = request_string('cat_app_home_click_url');
