	...
	public function index()
	{
		...
		if (!empty($shop_base) && $shop_base['shop_status'] == 3 && $check_shop_show)
		{
			...
			if (($shop_base['is_renovation'] && $shop_base['is_only_renovation'] == "0") || !$shop_base['is_renovation'])
			{
                ...
                $goods_best_seller_list = $this->goodsCommonModel->getGoodsList(array(
                                                                            "shop_id" => $shop_id,
                                                                            "common_is_best_seller" => 1,
                                                                            "common_state" => 1,
                                                                            'common_verify' =>1
                                                                        ), array(), 1, 12);
                $goods_is_discount =  $this->goodsCommonModel->getGoodsList(array(
                                                                            "shop_id" => $shop_id,
                                                                            "common_is_discount" => 1,
                                                                            "common_state" => 1,
                                                                            'common_verify' =>1
                                                                        ), array(), 1, 12);
		...
		if ('json' == $this->typ)
		{
            ...
            $data['goods_best_seller_list']   = empty($goods_best_seller_list) ? array() : $goods_best_seller_list;
            $data['goods_is_discount']   = empty($goods_is_discount) ? array() : $goods_is_discount;
