...
.tip-area h5{font-size:14px;position:absolute;left:-25px;top:-24px;background:#0dbd3b;color:#fff;padding: 30px 20px 6px 40px;font-weight:normal;border-radius:26px;letter-spacing:3px;}
