...
class Shop_BaseModel extends Shop_Base
{
    ...
    public function getBaseList($cond_row = array(), $order_row = array(), $page = 1, $rows = 100)
    {
        ...
        $erp_organizationModel = new ERP_OrganizationModel();
        ...
        foreach ($data["items"] as $key => $value) {
            ...
            if ($value['shop_organization']) {
                $shop_organization = $value['shop_organization'];
                $data["items"][$key]["shop_organization_name"] = $erp_organizationModel->getOrganizationName("$shop_organization");
            }
    ...
    public function getShopDetail($shop_id)
    {
        ...
        if ($data) {
            ...
            $data['shop_company_name'] = $shop_company['shop_company_name'];
    ...
    //获取店铺的销量
    function getShopSales($seller_user_id, $date)
    {
        $orderModel = new Order_BaseModel();
        $cond_row['seller_user_id'] = $seller_user_id;
