...
<script type="text/javascript" src="<?=$this->view->js_com?>/plugins/jquery.toastr.min.js" charset="utf-8"></script>
        ...
        <div style="height:400px;" class="slideBox">
            <div class="hd">
                <ul>
            ...
            <?php if(Web_ConfigModel::value('groupbuy_allow')){ ?>
                ...
                <div class="wrap floor fn-clear">
                    ...
                    ?>
                        ...
                        <?php if(($key < count($adv_list['items']) - 1)){?>
                            <div class="floor_gg">
                                <a target="_blank" id="<?=$key?>" href="<?=$floor_images[$key]['url']?>">
                                    <img src="<?=$this->view->img."/".$floor_images[$key]['src']?>"></a>
                            </div>
                        <?php } ?>
                    <?php } }?>
                </div>
