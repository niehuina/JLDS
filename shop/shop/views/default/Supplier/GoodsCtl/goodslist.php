...
<style type="text/css">
	.apply_distributor{
		padding: 3.5px 50px;background-color: #D13030;color: white;
	}
</style>
		<div class="hr">
		</div>
				...
				<ul class="cr_xie clearfix">
					...
					<li>
						...
						<div class="list_padd">
							...
							<a onclick="collectGoods(<?=(@$val['goods_id'])?>)" class="cr_xie_lia2" id="coll_<?=(@$val['goods_id'])?>"><span class="cr_xie_lia2_span1 iconfont <?php if($val['is_favorite']){?> icon-taoxinshi bbc_color <?php }else{?> icon-icoheart <?php }?>"></span><span class="cr_xie_lia2_span2" ><?=__('收藏')?></span></a>
							...
							<?php if(isset($suppliers) && !in_array($val['shop_id'],$suppliers)){?>
                            	<a class="apply_dist"  data-id = <?=$val['shop_id']?> style="padding: 3.5px 50px;background-color: #D13030;color: white;"><?=__('申请分销商')?></a>
                            ...
                            <?php }elseif($val['product_is_behalf_delivery'] && isset($suppliers) && in_array($val['shop_id'],$suppliers)){?>
                            	...
                            	<a  style="padding: 3.5px 50px;background-color: #D13030;color: white;" > <?=__('已分销')?> </a>
                            	<?php }else{?>
                            	<a class="add_distributor" data-id=<?=$val['common_id']?> style="padding: 3.5px 50px;background-color: #D13030;color: white;" > <?=__('一键上架')?> </a>
                            	<?php }?>	
                            <?php }?>	
