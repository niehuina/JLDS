                ...
                <div class="crumbs clearfix">
                    <p>
                        ...
                        <?php foreach($parent_cat as $catkey => $catval):?>
                            <a href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Goods&met=goodslist&cat_id=<?=($catval['cat_id'])?>"><?=($catval['cat_name'])?></a><?php if(!isset($catval['ext'])){ ?><i class="iconfont icon-iconjiantouyou"></i><?php }?>
                        <?php endforeach;?>
                        <?php }?>
                    </p>
                </div>
                                    ...
                                    <?php if (isset($goods_detail['goods_base']['image_row']) && $goods_detail['goods_base']['image_row'] )
                                    {
                                        ...
                                        { ?>
                                            <li <?php if ($imv['images_is_default'] == 1){ ?>class="check"<?php } ?>>
                                                <img class='lazy'   data-original="<?= image_thumb($imv['images_image'],60,60) ?>"/>
                                                <input type="hidden" value="<?=image_thumb($imv['images_image'],366,340)?>" rel="<?=image_thumb($imv['images_image'],900,976)?>">
                                            </li>
                                        <?php }
                                    }else{ ?>
                                        <li class="check">
                                            <img class='lazy'  data-original="<?= image_thumb($goods_image,60,60) ?>"/>
                    ...
                    <div class="ev_center">
                        ...
                        <div class="obvious">
                            ...
                            <p class="clearfix">
                                ...
                                <span class="mar-b-1" style="color:#D13030;font-weight:bold;">
                            ...
                            <p class="clearfix"><span class="mar-r _letter-spacing-2"><?=__('商品评价')?>：</span>
                                <span class="color-1876d1 mar-b-4 "><a href="#elist" name="elist" class="pl"><i class="num_style"><?=($goods_detail['common_base']['common_evaluate'])?></i> <?=__('条评论')?></a></span>
                            </p>
                        </div>
                        <div class="goods_style_sel ">
                            <div>
                                ...
                                <?php if(isset($goods_detail['goods_base']['promotion_type']) || $goods_detail['goods_base']['have_gift'] == 'gift' || !empty($goods_detail['goods_base']['increase_info']) || !empty($goods_detail['mansong_info'])){?>
                                    ...
                                    <span class="span_w lineh-1 mar_l "><?=__('促')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=__('销')?>：</span>
                                        ...
                                        <?php if($goods_detail['goods_base']['increase_info']) { ?>
                                            <div class="ncs-mansong">
                                                ...
                                                <span class="sale-rule">
                                                  ...
                                                  <?=__('购物满')?><em><?=format_money($goods_detail['goods_base']['increase_info']['rule'][0]['rule_price'])?></em><?=__('即可加价换购')?><?php if($goods_detail['goods_base']['increase_info']['rule'][0]['rule_goods_limit']):?><?=($goods_detail['goods_base']['increase_info']['rule'][0]['rule_goods_limit'])?><?=__('样')?><?php endif;?><?=__('商品')?>
                                                  <?php }?>
                                                  ...
                                                  <span class="sale-rule-more" nctype="show-rule">
                                                    <a href="javascript:void(0);"><?=__('共')?>
                                                        ...
                                                        <?=__('样')?>，<?=__('展开')?><i class="iconfont icon-iconjiantouxia"></i>
                                                    </a>
                                                  </span>

                                                  <div class="sale-rule-content" style="display: none;" nctype="rule-content">
                                                    <div class="title"><span class="sale-name"><?=__('加价购')?></span><?=__('共')?>
                                                    <strong><?php echo count($goods_detail['goods_base']['increase_info']['goods']);?></strong>
                                                    <?=__('样')?>，<?=__('换购商品')?><a href="javascript:;" nctype="hide-rule"><?=__('关闭')?></a></div>
                                                    <div class="content clearfix">
                                                      ...
                                                      <ul class="mjs-info clearfix">
                                                        <?php foreach($goods_detail['goods_base']['increase_info']['goods'] as $goods) { ?>
                                                          <li>
                                                            <a href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Goods&met=goods&gid=<?=($goods['goods_id'])?>" title="<?=($goods['goods_name'])?>" target="_blank" class="gift"> <img src="<?=image_thumb($goods['goods_image'],80,80)?>" alt="<?=($goods['goods_name'])?>"> </a>&nbsp;
                                                          </li>
                                                         <?php }?>
                                                      </ul>
                                                    </div>
                                        ...
                                        <div class="ncs-mansong">
                                            ...
                                            <span class="sale-rule">
                                              ...
                                              <?php if(!empty($rule['rule_discount'])) { ?>
                                                  ，<?=__('即享')?><em><?=($rule['rule_discount'])?></em><?=__('折优惠')?>
                                              <?php } ?>
                                              <?php if(!empty($rule['goods_id'])) { ?>
                                              <?=__('，送')?><a href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Goods&met=goods&gid=<?=($rule['goods_id'])?>" title="<?=($rule['goods_name'])?>" target="_blank"><?=__('赠品')?></a>
                                              <?php } ?>
                                              </span> <span class="sale-rule-more" nctype="show-rule"><a href="javascript:void(0);"><?=__('共')?><strong><?php echo count($goods_detail['mansong_info']['rule']);?></strong><?=__('项')?>，<?=__('展开')?><i class="iconfont icon-iconjiantouxia"></i></a></span>
                                              <div class="sale-rule-content" style="display: none;" nctype="rule-content">
                                                <div class="title"><span class="sale-name"><?=__('满即送')?></span><?=__('共')?><strong><?php echo count($goods_detail['mansong_info']['rule']);?></strong><?=__('项')?>，<?=__('促销活动规则')?><a href="javascript:;" nctype="hide-rule"><?=__('关闭')?></a></div>
                                                <div class="content clearfix">
                                                  ...
                                                  <ul class="mjs-info">
                                                    ...
                                                    <li> <span class="sale-rule"><?=__('购物满')?><em><?=format_money($rule['rule_price'])?></em>
                                                      ...
                                                      <?php } ?>
                                                      <?php if(!empty($rule['goods_id'])) { ?>
                                                          ， <?=__('送')?> <a href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Goods&met=goods&gid=<?=($rule['goods_id'])?>" title="<?=($rule['goods_name'])?>" target="_blank" class="gift"> <img src="<?=image_thumb($rule['goods_image'],60,60)?>" alt="<?=($rule['goods_name'])?>"> </a>&nbsp;。
                                                      <?php } ?>
                                                      </span> </li>
                                                    <?php } ?>
                                                  </ul>
                            ...
                            <p class="clearfix"><span class="mar-r _letter-spacing-2"><?=__('门店服务')?>：</span>
                                <span class="color-1876d1 mar-b-4 "><a href="#" name="elist" class="num_style mendian" nctype="get_chain"> <i class="iconfont icon-tabhome"></i><?=__('门店自提')?></a>· <?=__('选择有现货的门店下单')?>，<?=__('可立即提货')?></span>
                            </p>
                            <?php }?>
                            <?php if($goods_status){?>
							...
							<?php 
								...
								{
							?>
                            	<a class="apply_dist" data-id=<?=$goods_detail['goods_base']['shop_id']?> style="margin-top:10px;display:inline-block;padding: 10px 50px;background-color: #D13030;color: white;"><?=__('申请分销商')?></a>
                            ...
                            <?php }elseif($goods_detail['common_base']['product_is_behalf_delivery'] && isset($suppliers) && in_array($goods_detail['goods_base']['shop_id'],$suppliers)){?>
                            	...
                            	<a  style="margin-top:10px;display:inline-block;padding: 10px 50px;background-color: #D13030;color: white;" > <?=__('已分销')?> </a>
                            	<?php }else{?>
                            	<a class="add_distributor" data-id=<?=$goods_detail['goods_base']['common_id']?> style="margin-top:10px;display:inline-block;padding: 10px 50px;background-color: #D13030;color: white;" > <?=__('一键上架')?> </a>
                            	<?php }?>
                            <?php }?>	
                        ...
                        <ul class="look_again_goods clearfix ">
                            <?php if (!empty($data_recommon_goods))
                            {
                                foreach ($data_recommon_goods as $key_recommon => $value_recommon)
                                {
                                    ?>
                                    <li>
                                        <a target="_blank" href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Goods&met=goods&gid=<?=($value_recommon['goods_id'])?>">
        ...
        <div class="t_goods_bot clearfix ">
                ...
                <div class="goods_ranking ">
                        ...
                        <?php if (!empty($data_salle))
                            {
                                foreach ($data_salle as $key_salle => $value_salle)
                                   {?>
                                <li class="clearfix">
                                    <a target="_blank" href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Goods&met=goods&gid=<?= ($value_salle['goods_id']) ?>"
                                                       class="selling_goods_img"><img src="<?= $value_salle['common_image'] ?>"></a>

                                        <p>
                                           <a target="_blank" href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Goods&met=goods&gid=<?= ($value_salle['goods_id']) ?>"><?= $value_salle['common_name'] ?></a>
                    ...
                    <ul style="display: none;" id="hot_collect">
                        <?php if (!empty($data_collect))
                        {
                            ...
                            ?>
                               <li class="clearfix">
                                  <a target="_blank" href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Goods&met=goods&gid=<?= $value_collect['goods_id'] ?>"
                                                       class="selling_goods_img"><img src="<?= $value_collect['common_image'] ?>"></a>

                                     <p>
                                        <a target="_blank" href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Goods&met=goods&gid=<?= $value_collect['goods_id'] ?>"><?= $value_collect['common_name'] ?></a>
            ...
            <div class="t_goods_bot_right ">
                <ul class="goods_det_about goods_det clearfix border_top">
                    ...
                    <li><a class="pl"><?=__('商品评论')?><span><?=__('(')?><?=($goods_detail['common_base']['common_evaluate'])?><?=__(')')?></span></a></li>
                    <?php if($entity_shop){?>
                    <li><a class="wz"><?=__('商家位置')?></a></li>
                    <?php }?>
                    <li><a class="bz"><?=__('分销说明')?></a></li>
                </ul>
