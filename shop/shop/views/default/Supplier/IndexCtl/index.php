        ...
        <div style="height:500px;" class="slideBox">
            ...
            <div class="banner  bd">
                ...
                <div class="wrap t_cont clearfix">
                    <ul class="tcenter">
                        <li> <a href="<?php echo Web_ConfigModel::value('supplier_index_img_link1');?>"><img src="<?php  echo Web_ConfigModel::value('supplier_index_img1');?>"/></a></li>
                        <li> <a href="<?php echo Web_ConfigModel::value('supplier_index_img_link2');?>"><img src="<?php echo Web_ConfigModel::value('supplier_index_img2');?>"/></a></li>
                    </ul>
