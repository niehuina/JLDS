...
<div class="ncsc-oredr-show">
    <div class="ncsc-order-info">
        <div class="ncsc-order-details">
            ...
            <div class="content">
                ...
                <dl class="line">
                    <dt><?=__('服务信息')?>：</dt>
                    <dd><?php echo $order_data['receiver_info'] ; ?></dd>
                </dl>
    ...
    <div class="ncsc-order-contnet">
        <table class="ncsc-default-table order">
            ...
            <tr>
                <th colspan="20">
                    <span class="ml10" title="<?=__('我的订单')?>服务订单号"><?=__('服务订单号')?>：<?php echo $order_data['order_id']; ?></span><span><?=__('下单时间')?>：<?php echo $order_data['order_create_time']; ?></span>
                </th>
            </tr>
            <tr>
                <td class="bdl"></td>
