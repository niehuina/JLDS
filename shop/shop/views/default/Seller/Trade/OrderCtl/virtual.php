...
<table class="table-list-style order-list-style ncsc-default-table2 ncsc-default-table order" width="100%" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td class="bdl">
			<dl class="fn-clear">
				<dt>
					<a target="_blank" href="<?php /* 服务商品单次购买 */ echo Yf_Registry::get('url') . '?ctl=Goods_Goods&met=goods&type=goods&gid=' . $goods_list['goods_id']; ?>"><img width="60px" height="60px" src="<?php echo $goods_list['goods_image']; ?>"></a>
				</dt>
				<dd>
					<a target="_blank" href="<?php /* 服务商品单次购买 */ echo Yf_Registry::get('url') . '?ctl=Goods_Goods&met=goods&type=goods&gid=' . $goods_list['goods_id']; ?>"><?php echo $goods_list['goods_name']; ?></a>
