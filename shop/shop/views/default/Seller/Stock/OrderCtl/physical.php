    ...
    <table class="search-form">
        ...
        <tr>
            ...
            <?php if(!self::$is_partner){ ?>
                <th><?=__('高级合伙人')?></th>
                <td class="w100">
                    <input type="text" class="text w100" placeholder="<?=__('请输入用户名')?>" id="query_buyer_name" name="query_buyer_name" value="<?=$_GET['query_buyer_name']?>">
                </td>
            <?php } ?>
            <td>&nbsp;</td>
            <td>
        ...
        <tr>
            <th><?=__('订单编号')?></th>
            <td class="w160">
                <input type="text" class="text w240 heigh" placeholder="<?=__('请输入订单编号')?>" id="query_order_sn" name="query_order_sn" value="<?=$_GET['query_order_sn']?>">
            </td>
            <td class="w70 tc">
