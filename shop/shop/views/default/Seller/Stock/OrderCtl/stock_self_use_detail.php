...
?>
    ...
    <table class="search-form">
        ...
        <tr>
            <td width="w100">
                <p>商品自用时间：<?=($stock_out['out_time']);?></p>
            </td>
            <td>
                <p>商品自用数量：<?=($goods_count);?></p>
            </td>
            <td>
                <div id="search_form" class="search_form_reset">
                    <input type="hidden" id="out_order_id" value="<?=($out_order_id);?>">
    ...
    <script type="text/javascript" src="<?=$this->view->js?>/stock_self_use_detail.js" charset="utf-8"></script>
