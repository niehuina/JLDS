        ...
        <div class="adds">
            ...
            <form id="address_form">
                ...
                <dl>
                    ...
                    <dd>
                        <input type="text" class="text" name="order_receiver_phone" id="order_receiver_phone" value="">
                    </dd>
                </dl>
                <dl>
...
<script>
    ...
    $( function () {
        ...
        $('#order_receiver_phone').val(address_data.order_receiver_phone);
        ...
        $('#address_form').validator({
            ...
            fields: {
                ...
                'order_receiver_phone':   'required;mobile;',
