    ...
    <div class="user-box">
        <div class="user-joinin">
            ...
            <div class="bottom">
                ...
                <?php }else{ ?>
                    <a href="index.php?ctl=Seller_Supplier_Settled&met=index&op=<?php if(Web_ConfigModel::value('supplier_type') == 3){echo 'step0';}else{echo 'step1';}?>" target="_blank"> <?=__('我要入驻')?></a>
                <?php } ?>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function getStep(){
        var url = "<?= Yf_Registry::get('base_url')?>/index.php?ctl=Seller_Supplier_Settled&met=getstepurl&typ=json"; 
