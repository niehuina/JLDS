					...
					<table id="table_list" class="table_list">
						...
						<?php foreach($val['goods'] as $k=>$v){ ?>
                            <?php
                                ...
                                $data_min = $v['goods_base']['lower_limit'] ? $v['goods_base']['lower_limit'] : 1 ;
                            ?>
							<tr class="row_line">
								...
								<td class="goods_num">
									...
									<p class="clearfix"><a class="<?php if($v['goods_num'] == 1){?>no_<?php }?>reduce" ><?=__('-')?></a><input id="nums" data-id="<?=($v['cart_id'])?>" data-max="<?=($data_max)?>" data-min="<?=$data_min?>" value="<?=($v['goods_num'])?>"><a class="<?php if($data_max <= 1){?>no_<?php }?>add" ><?=__('+')?></a></p>
