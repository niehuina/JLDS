              ...
              <ul>
                ...
                <li class="favorite-pic-list">
                  ...
                  <div class="handle">
                    ...
                    <?php if(!empty($val['common']) && $val['common']['common_is_virtual']){?>
                    <a href="javascript:void(0)" class="fr buy_now" title="<?=__('立即购买')?>" data-param="{'ctl':'Buyer_Cart','met':'buyVirtual','id':'<?=$val['goods_id']?>','num':'1'}"><i class=""><?=__('立即购买')?></i></a>
                    <?php }else{ ?>
