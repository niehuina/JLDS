    ...
    <div class="t_goods_bot_right-1">
      <div class="bbc-main-container">
        ...
        <div class="bbc-main-container">
            ...
            <div class="content_s bbc-goods-list">
                <ul>
                    <?php if (!empty($goods_best_seller_list['items'])) {

                        foreach ($goods_best_seller_list['items'] as $key => $value) {
        ...
        <div class="bbc-main-container">
            ...
            <div class="content_s bbc-goods-list">
                <ul>
                    <?php if (!empty($goods_is_discount['items'])) {
                        foreach ($goods_is_discount['items'] as $key => $value) {
