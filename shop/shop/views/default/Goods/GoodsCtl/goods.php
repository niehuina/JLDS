...
<link href="<?= $this->view->css ?>/login.css" rel="stylesheet">
    ...
    <style>
        ...
        .tuan_go_gray,tuan_join_cart,.tuan_join_cart_gray,.tuan_go_gray{display: inline-block;padding: 0 30px;text-align: center;font-size: 18px;border-radius: 2px;}
        .tuan_go{border: 2px solid #d73834; height: 36px;line-height: 36px;}
        .tuan_join_cart_gray,.tuan_go_gray{line-height:40px;height:40px;}
        .tuan_go_gray{border: 2px solid #d73834;border-color:#ccc !important;color:#ccc;}
        .tuan_join_cart_gray{background:#ccc; margin-right: 8px; margin-left: 72px;line-height: 40px; height: 40px;}
    </style>
                ...
                <div class="t_goods_ev clearfix">
                    <div class="ev_left">
                        ...
                        <div class="ev_left_num">
                            ...
                            <span onclick="collectGoods(<?=($goods_detail['goods_base']['goods_id'])?>)">
                                <b class="top iconfont icon-2 bbc_color <?php if($isFavoritesGoods){ ?> icon-taoxinshi<?php }else{?>  icon-icoheart <?php }?>"></b><em class="top"><?=__('收藏')?></em>
                            </span>
                            ...
                            <span class="cprodict ">
                                <a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Service_Report&met=index&act=add&gid=<?=($goods_detail['goods_base']['goods_id'])?>">
                                    <b class="top iconfont icon-jubao icon-1 bbc_color"><em class="top"></b><?=__('举报')?></em>
                                </a>
                            </span>
                        </div>
                    ...
                    <div class="ev_center">
                        ...
                        <div class="goods_style_sel ">
                            ...
                            <p class="mar-top mar-bottom">
                                <span class="span_w mar_l mar_w"><?=__('仓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;库：')?></span>
                                <span class="span_font12 clearfix">该商品由 <b>临沂保税仓</b> 发货</span>
                            </p>

                            <p class="mar-top mar-bottom">
                                <span class="span_w mar_l mar_w"><?=__('税&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;率：')?></span>
                                <span class="span_tax clearfix">
                                    消费税率：<?=Web_ConfigModel::value("consumption_tax");?>%&nbsp;,&nbsp;增值税率：<?=Web_ConfigModel::value("value_added_tax");?>%
                                </span>
                            </p>
