                    ...
                    <p>
                        <?php if ($parent_cat) { ?>
                            <?php foreach ($parent_cat as $catkey => $catval): ?>
                                <a
                                href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goodslist&cat_id=<?= ($catval['cat_id']) ?>"><?= ($catval['cat_name']) ?></a><?php if (!isset($catval['ext'])) { ?>
                ...
                <div class="t_goods_ev clearfix">
                    ...
                    <div class="ev_center">
                        <div class="ev_head">
                            ...
                            <h3><?= (trim($goods_detail['goods_base']['goods_name'])) ?>
                                <?php if ($goods_detail['common_base']['common_is_preference']): ?>
                                    <p class="bbc_color"><?= __('[特惠]') ?></p>
                                <?php endif; ?>
                        ...
                        <div class="obvious">
                            ...
                            <?php if (Perm::$row['user_minimum_living_status'] == 1) { ?>
                                <p class="clearfix">
                                    <span class="mar-r _letter-spacing"><?= __('低保价：') ?></span>
                                    <span class="mar-b-1"><?= format_money($goods_detail['common_base']['common_dibao_price']) ?>  </span>
                                </p>
                            <?php } ?>
                            <p class="clearfix">
                            ...
                            <p class="clearfix"><span class="mar-r _letter-spacing-2"><?= ('商品评价：') ?></span>
                                <span class="color-1876d1 mar-b-3 "><a href="#elist" name="elist" class="pl"><i
                            ...
                            <p class="clearfix"><span
                                ...
                                <span class="color-1876d1 mar-b-5 "><a href="#elist" name="elist" class="pl"><i
                                              ...
                                              <?php $rule = $goods_detail['mansong_info']['rule'][0]; ?>
                                                ...
                                                <?php } ?>
                                                        ...
                                                        <?php } ?>
                                                                ...
                                                                href="javascript:void(0);"><?= __('共') ?><strong><?php echo count($goods_detail['mansong_info']['rule']); ?></strong><?= __('项，展开') ?><i
                                                                    class="iconfont icon-iconjiantouxia"></i></a></span>
                                                    <div class="sale-rule-content" style="display: none;"
                                                         nctype="rule-content">
                            ...
                            <?php if ($goods_status) { ?>
                                ...
                                <p class="need_num clearfix">
                                    ...
                                    <span class="goods_num">
                                            ...
                                            <input id="nums" name="nums"
                                                   data-id="<?= ($goods_detail['goods_base']['goods_id']) ?>"
                                                   data-min="<?php if ($goods_detail['goods_base']['lower_limit']): ?><?= ($goods_detail['goods_base']['lower_limit']) ?><?php else: ?><?= (1) ?><?php endif; ?>"
                                                   data-max="<?php if ($goods_detail['buyer_limit']): ?><?= ($goods_detail['buyer_limit']) ?><?php else: ?><?= ($goods_detail['goods_base']['goods_stock']) ?><?php endif; ?>"
                                                   value="<?php if ($goods_detail['goods_base']['lower_limit']) echo $goods_detail['goods_base']['lower_limit']; else echo 1; ?>">
                                            <input type="hidden"
                        ...
                        <div class="ev_right_pad ">
                            ...
                            <?php if ($shop_detail['shop_self_support'] == 'false') { ?>
                                <div class="brandself ">
                                    ...
                                    <ul class="shop_score_content clearfix ">
                                        <li>
                                            ...
                                            <em class="bbc_color"><?= number_format(abs($shop_detail['com_desc_scores']), 2, '.', '') ?></em>
                                        </li>
                                        <li>
                                            ...
                                            <em class="bbc_color"><?= number_format(abs($shop_detail['com_service_scores']), 2, '.', '') ?></em>
                                        </li>
                                        <li>
                                            ...
                                            <em class="bbc_color"><?= number_format(abs($shop_detail['com_send_scores']), 2, '.', '') ?></em>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="shop_address">
                                    <p>
                                        <span class="addr_t"><?= __('公司名称') ?></span>：<?= ($shop_detail['shop_company_name']) ?>
                                    </p>
                                    <p>
                                        <span class="addr_t"><?= __('所在地') ?></span>：<?= ($shop_detail['shop_company_address']) ?>
                                    </p>
                                </div>
                                ...
                                <div class="follow_shop ">
                                    ...
                                    <a onclick="collectShop(<?= ($shop_detail['shop_id']) ?>)"
        ...
        <div class="t_goods_bot clearfix ">
            <div class="t_goods_bot_left ">
                ...
                <div class="goods_classify ">
                    ...
                    <p class="classify_like">
                        ...
                        <a href="<?= Yf_Registry::get('url') ?>?ctl=Shop&met=goodsList&id=<?= $shop_detail['shop_id']; ?>&order=common_collect"><?= __('按人气') ?></a>
                    </p>
                    ...
                    <ul id="hot_salle">
                        <?php if (!empty($data_salle)) {
                            foreach ($data_salle as $key_salle => $value_salle) {
                                ...
                                <li class="clearfix">
                                    <a target="_blank"
                                       href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?= ($value_salle['goods_id']) ?>"
                                       class="selling_goods_img"><img class='lazy'
                                                                      data-original="<?= $value_salle['common_image'] ?>"></a>

                                    <p>
                                        <a target="_blank"
                                           href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?= ($value_salle['goods_id']) ?>"><?= $value_salle['common_name'] ?></a>
                    ...
                    <ul style="display: none;" id="hot_collect">
                        <?php if (!empty($data_collect)) {
                            foreach ($data_collect as $key_collect => $value_collect) {
                                ...
                                <li class="clearfix">
                                    <a target="_blank"
                                       href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?= $value_collect['goods_id'] ?>"
                                       class="selling_goods_img"><img class='lazy'
                                                                      data-original="<?= $value_collect['common_image'] ?>"></a>

                                    <p>
                                        <a target="_blank"
                                           href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?= $value_collect['goods_id'] ?>"><?= $value_collect['common_name'] ?></a>
            ...
            <div class="t_goods_bot_right ">
                <ul class="goods_det_about goods_det clearfix border_top">
                    ...
                    <li class="al"><a class="pl"><?= __('商品评论') ?>
                            <span><?= __('(') ?><?= ($goods_detail['goods_base']['evalcount']) ?><?= __(')') ?></span></a>
                    </li>
    ...
    <script>
        ...
        $('a[nctype="get_chain"]').click(function () {
            ...
            $.ajax({
                ...
                data: {goods_id: goods_id, shop_id: shop_id, goods_num: $('#nums').val()},
                dataType: 'JSON',
                success: function (data) {
                    if (data.status != 250) {
                        $.dialog({
    ...
    <script>
        ...
        $('.share').click(function () {
            if ($('.bshare-custom').css('display') == 'block') {
                $('.bshare-custom').hide();
                $(".bshare-custom").addClass('hidden');
            } else {
                $('.bshare-custom').show();
                $(".bshare-custom").removeClass('hidden');
            }
        });
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function _calc() {
                ...
                if (!calc_area_id) calc_area_id = <?=$_COOKIE['goodslist_area_id']?>;
