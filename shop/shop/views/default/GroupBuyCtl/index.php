...
<div class="wrap">
	<div class="t_ban">
		...
		<div class="tg tg_left">
            ...
            <h5><a href="<?=Yf_Registry::get('url')?>?ctl=GroupBuy&met=vrGroupBuyList"><?=__('服务团')?></a></h5>
            <p>
                <?php
                if($data['cat']['virtual'])
                {
	...
	<div class="groups">
		<h3>
            <a href="<?=Yf_Registry::get('url')?>?ctl=GroupBuy&met=vrGroupBuyList"><?=__('服务团')?></a><i><?=__('每天整点开抢')?></i>
