        ...
        <div id="cti">
            <div class="wrapper">
                <ul style="margin-left:70px">
                    <li> <img style="" src="<?=$this->view->img?>/bnotice_1.png">  <span class="name"></span> </li>
                    <li><span class="line"></span> <span class="icon"> <img style="" src="<?=$this->view->img?>/bnotice_2.png"> </span> <span class="name">  </span> </li>
                    <li><span class="line"></span> <span class="icon"> <img style="" src="<?=$this->view->img?>/bnotice_3.png"> </span> <span class="name"> </span> </li>
                    <li><span class="line"></span> <span class="icon"> <img style="" src="<?=$this->view->img?>/bnotice_4.png"> </span> <span class="name"> </span> </li>
                </ul>
            </div>
        </div>
