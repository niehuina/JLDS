...
//        );
    ...
    //销售订单
    function invoke_saleorder($cookie_jar)
    {
       $sContent = "{\"FormId\":\"SAL_SaleOrder\", \"Creator\":\"String\",\"NeedUpDateFields\":[\"FBillTypeID\",\"FDate\",\"FBusinessType\",\"FSaleOrgId\",\"FCustId\",\"FSettleCurrId\",\"FSalerId\",\"SAL_SaleOrder__FSaleOrderEntry\",\"FMaterialId\",
        \"FSettleOrgIds\",\"FUnitID\",\"FQty\",\"SAL_SaleOrder__FSaleOrderFinance\",\"FSettleCurrId\",\"FLocalCurrId\",\"FIsIncludedTax\",\"FBillTaxAmount\",\"FBillAmount\",\"FBillAllAmount\",\"FExchangeTypeId\",\"FExchangeRate\"],\"Model\":{\"FID\":0,
        \"FBillTypeID\":{\"FNumber\":\"XSDD01_SYS\"},\"FBusinessType\":\"NORMAL\",\"FSaleOrgId\":{\"FNUMBER\":\"100\"},\"FCustId\":
        {\"FNUMBER\":\"CUST0001\"},\"FSettleCurrId\":{\"FNUMBER\":\"PRE001\"},\"FSalerId\":{\"FNUMBER\":\"0002\"},\"SAL_SaleOrder__FSaleOrderFinance\":{\"FExchangeRate\":6.8123},\"SAL_SaleOrder__FSaleOrderEntry\":
        [{\"FMaterialId\":{\"FNUMBER\":\"1101144445\"},\"FSettleOrgIds\":{\"FNUMBER\":\"100\"},\"FUnitID\":{\"FNumber\":\"个\"},\"FQty\":10}]}}";

        $saleorderresult = $this->invoke_save(self::CLOUD_URL,$sContent, $cookie_jar);
    ...
    function invoke_save($cloudUrl,$post_content,$cookie_jar)
    {
       ...
       // return invoke_post($invokeurl,$post_content,$cookie_jar,FALSE);
        return $this-> async($invokeurl,$post_content,true,self::REQ_POST,$cookie_jar,true);
    }
    ...
    function invoke_view($cloudUrl,$post_content,$cookie_jar){
        ...
        $invkoeurl  = $cloudUrl. 'Kingdee.BOS.WebApi.ServicesStub.DynamicFormService.View.common.kdsvc';
        return  $this-> async($invkoeurl,$post_content,true,self::REQ_POST,$cookie_jar,false);
    }
    //审核
