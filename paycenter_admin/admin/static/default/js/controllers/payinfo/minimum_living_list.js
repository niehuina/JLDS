...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
			...
			{name:'user_minimum_living_img', label:'低保证正面', width:120, align:"center","formatter": handle.imgFmt ,classes:'img_flied'},
            {name:'user_minimum_living_status_con', label:'状态', width:110, align:"center"},
        ];
        this.mod_PageConfig.gridReg('grid', colModel);
        colModel = this.mod_PageConfig.conf.grids['grid'].colModel;
        $("#grid").jqGrid({
            url: SITE_URL +'?ctl=Paycen_PayInfo&met=getMinimumLivingList&typ=json',
...
var handle = {
    operate: function (t, e)
    {
        ...
        {
            var i = "审核低保验证", a = {oper: t, rowData: $("#grid").jqGrid('getRowData',e), callback: this.callback};
            console.info(a);
        }
        $.dialog({
            title: i,
            content: "url:./index.php?ctl=Paycen_PayInfo&met=getMinEditInfo&user_id="+e,
            data: a,
            width: 550,
            height: 100,
            max: !1,
