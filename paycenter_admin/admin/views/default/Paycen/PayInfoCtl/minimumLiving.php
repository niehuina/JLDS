...
?>
        ...
        <div class="fixed-bar">
            <div class="item-title">
                ...
                <ul class="tab-base nc-row">
                    <li><a class="" href="index.php?ctl=Paycen_PayInfo&met=index"><span>实名认证</span></a></li>
                    <li><a class="current" href="index.php?ctl=Paycen_PayInfo&met=minimumLiving"><span>低保认证</span></a></li>
                </ul>
            </div>
        </div>
    ...
    <script src="./admin/static/default/js/controllers/payinfo/minimum_living_list.js"></script>
<?php
