            ...
            <div class="nav-wrap hidden cf"><!--订单-->
                <ul id="nav" class="cf">
                    <li class="item item-setting cur">
                        <a href="javascript:void(0);" class="setting main-nav">
                            <i class="iconfont icon-silde02"></i>
                            <p>设置</p><s></s>
                        </a>
                    </li>
                ...
                <div id="sub-nav">
                    <ul class="cur cf" id="setting-base">
                        ...
                        <li>
                            ...
                            <a data-right="BU_QUERY" href="index.php?ctl=Config&met=site&typ=e&config_type%5B%5D=site"
                               rel="pageTab" tabid="site-setting" tabtxt="基础设置">基础设置</a>
                        </li>

                        <li>
                            <i class="iconfont icon-point"></i>
                            <a data-right="BU_QUERY" href="index.php?ctl=Config&met=api&typ=e&config_type%5B%5D=api"
                               rel="pageTab" tabid="api-setting" tabtxt="API设置">API设置</a>
                        </li>
                        <li>
                            <i class="iconfont icon-point"></i>
                            <a data-right="BU_QUERY" href="index.php?ctl=Payment_Channel&met=index&typ=e" rel="pageTab"
                               tabid="sale_order_manage" tabtxt="支付方式设置">支付方式设置</a></li>

                        <li>
                            <i class="iconfont icon-point"></i>
                            <a data-right="BU_QUERY" href="index.php?ctl=User_App&met=index" rel="pageTab"
                               tabid="sale_order_manage" tabtxt="支付应用管理">支付应用管理</a>
                        </li>

                        <?php if (is_dir(APPPATH . '/../upgrade')) { ?>
                            <li>
                                <i class="iconfont icon-point"></i>
                                <a data-right="BU_QUERY" href="index.php?ctl=Config&met=update" rel="pageTab"
                                   tabid="sale_order_manage" tabtxt="版本管理">版本管理</a>
                            </li>
                        <?php } ?>
                    ...
                    <ul class="cf" id="setting-manage">
                        <li>
                            <i class="iconfont icon-point"></i>
                            <a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayWithdraw&met=index" rel="pageTab"
                               tabid="PayWithdraw_Withdraw" tabtxt="提现服务">提现服务</a>
                        </li>
<!--                        <li>-->
<!--                            <i class="iconfont icon-point"></i>-->
<!--                            <a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayCard&met=index" rel="pageTab"-->
<!--                               tabid="Paycen_PayCard" tabtxt="购物卡管理">购物卡管理</a>-->
<!--                        </li>-->
                        <li>
                            <i class="iconfont icon-point"></i>
                            <a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayRecord&met=index" rel="pageTab"
                               tabid="Paycen_PayRecord_index" tabtxt="资金明细">资金明细</a>
                        </li>
                    </ul>
                    ...
                    <ul class="cf" id="setting-manage">
                        <li>
                            <i class="iconfont icon-point"></i>
                            <a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayBase&met=index" rel="pageTab"
                               tabid="Paycen_PayBase" tabtxt="支付会员管理">支付会员管理</a>
                        </li>
                        <li>
                            <i class="iconfont icon-point"></i>
                            <a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayInfo&met=index" rel="pageTab"
                               tabid="Paycen_PayInfo" tabtxt="实名认证">实名认证</a>
                        </li>
                        <li>
                            <i class="iconfont icon-point"></i>
                            <a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayRecord&met=deleteUser_index" rel="pageTab"
                               tabid="Paycen_PayRecord_settle" tabtxt="退出用户结算">退出用户结算</a>
                        </li>
<!--                        <li>-->
<!--                            <i class="iconfont icon-point"></i>-->
<!--                            <a data-right="BU_QUERY" href="index.php?ctl=Paycen_BtInfo&met=index" rel="pageTab"-->
<!--                               tabid="Paycen_BtInfo" tabtxt="白条管理">白条管理</a>-->
<!--                        </li>-->
                    </ul>
                    ...
                    <ul class="cf" id="setting-manage">
                        <li>
                            <i class="iconfont icon-point"></i>
                            <a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayCapital&met=getCapitallist"
                               rel="pageTab" tabid="Paycen_PayCapital" tabtxt="系统资金总览">系统资金总览</a>
                        </li>
                    </ul>
...
<div id="selectSkin" class="shadow dn">
    <ul class="cf">
        <li>
            <a id="skin-default"><span></span>
                <small>经典</small>
            </a>
        </li>
        <li>
            <a id="skin-blue"><span></span>
                <small>丰收</small>
            </a>
        </li>
        <li>
            <a id="skin-green"><span></span>
                <small>小清新</small>
            </a>
        </li>
    </ul>
