...
class User_InfoDetail extends Yf_Model
{
     ...
     * @access public
     */
    public function getInfoDetail($table_key=null, $sort_key_row=null)
    {
        $rows = array();
        $rows = $this->get($table_key, $sort_key_row);
     ...
     * @access public
     */
    public function editInfoDetail($table_key=null, $field_row)
    {
     ...
     * @access public
     */
    public function editInfoDetailSingleField($table_key, $field_name, $field_value_new, $field_value_old)
    {
     ...
     * @access public
     */
    public function removeInfoDetail($table_key)
    {
    ...
    public function checkUserName($user_name,$user_id=0){
        if($user_id){
            $where = 'user_id!='.$user_id.' and (user_name="'.$user_name.'" or user_tel="'.$user_name.'" or user_mobile="'.$user_name.'" or user_email="'.$user_name.'")'; 
        }else{
            $where = 'user_name="'.$user_name.'" or user_tel="'.$user_name.'" or user_mobile="'.$user_name.'" or user_email="'.$user_name.'"';
        }
