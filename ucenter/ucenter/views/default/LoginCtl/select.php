		...
		<div class="tc form-con">
			<div class="center">
				...
				<dl class="clearfix">
					<dt>设置密码：</dt>
					<dd class="pas-set">
						<input type="password" id="re_user_password"  class="field re_user_password" placeholder="建议至少使用两种字符组合密码" maxlength="20"  onfocus="checkPwd()" onblur="pwdCallback()"  autocomplete="off">
